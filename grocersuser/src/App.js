...
class App extends Component {
  ...
  componentDidMount() {
    ...
    const url = "https://api.foursquare.com/v2/venues/search?v=20140806&ll=43.620495,-79.513199&categoryId=56aa371be4b08b9a8d573550&client_id=CFERCZSSMQJHIZUKNVAS0PMLTVDOWUGWMEE2OFYBZRFVXDFT&client_secret=OUAHA4JWGB4SY4FG1O1GQXEMDVBXQKFM0ZDUEHB1FKWSHR04";
    superagent
      .get(url)
      .query(null)
